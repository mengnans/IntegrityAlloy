...
//                       And a valid ChangeSettingsRequest message is received [Stone Change here]
...
pred bothOn[s: State]{
  all s: State | s.icd_mode in ModeOn =>
	s.impulse_mode in ModeOn	
}

pred bothOff[s: State]{
  all s: State | s.icd_mode in ModeOff =>
